...
export class DiscoverySession {
   ...
   * @param {string} site
   * @param {{ browserFactory?: () => object }} [opts]
   */
  constructor(sessionId, site, opts = {}) {
    ...
    /** Factory for creating browser instances (defaults to PlaywrightBrowser) */
    this._browserFactory = opts.browserFactory || (() => new PlaywrightBrowser());
  }
  ...
  async _processSnapshot(payload) {
    ...
    const browser = this._browserFactory();
